...
This data analysis effort looks at GDP and the categories of Income Group as provided by the World Bank data.  After cleaning the data and putting it in a usable format, there are 189 usable records to manipulate. <br/>

The up front modularization of the Case Study into the Makefile and Analysis .Rmd files is the key to our success.  This organizational approach simplifies the work effort across the team. <br/>

Once the data is clean, asking and answering questions is straight forward. The result is the .HTML file that incorporates the questions, code, and answer.  Having clean data allows us to extend the scope of the Case Study to ask questions about the relationship between GDP and Income Group. This models real world scenarios in which data analysis starts with a model in mind, but can change upon discovery of new or absent relationships.  For example, the GDP data is heavily right skewed indicating median as a better indicator of GDP than mean.  Or, what else can we learn from the relationship of GDP to OECD and nonOECD countries?<br/>

Visualization of data is incredibly important in telling a complete story and making the analysis useful. It is true that a picture is worth 1,000 words.  The GDP scatter plot showing the stacked GDP at the lower ends carries a greater impact that words alone. Data analysis requires thoughtful selection of visual aids to compliment the effort.<br/>

This Case Study exercise demonstrates that data analysis projects are not trivial.  There is significant time and effort across many people to create an accurate, relevant, and usable analysis.<br/>
